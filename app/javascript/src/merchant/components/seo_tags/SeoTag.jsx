      ...
      <div className="seo-tag">
        ...
        <div className="block">
          ...
          <div className="tab-content">
            <div id="seo_ko" className="tab-pane fade show active">
              <div className="mb-3">
                <label className="form-label">{I18n.t("activerecord.attributes.seo_tag.title")}</label>
              ...
              <div className="mb-3">
                <label className="form-label">{I18n.t("activerecord.attributes.seo_tag.meta_description")}</label>
              ...
              <div className="mb-3">
                <label className="form-label">{I18n.t("activerecord.attributes.seo_tag.meta_keywords")}</label>
