        ...
        <div className="block">
          <div className="row">
            ...
            <div className="col-sm-4">
              ...
              <p>{this.props.subscription ? this.props.subscription.plan.name : I18n.t("merchant.admin.pages.account.free_trial") + " - " + I18n.t("merchant.admin.pages.account.product_left", {count: this.props.remaining_products})} </p>
