var CustomPage = React.createClass({
  render: function() {
    return (
      <Item item={this.props.custom_page} deleteUrl={this.props.deleteUrl} handleSelect={this.props.handleSelect}
        handleDeleteItem={this.props.handleDeleteItem} check={this.props.custom_page.checked}>
        <td className="name">
