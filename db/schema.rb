...
ActiveRecord::Schema.define(version: 20160708085928) do
  ...
  create_table "banner_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["banner_id"], name: "index_banner_items_on_banner_id", using: :btree
  end
  ...
  create_table "custom_page_translations", force: :cascade do |t|
    ...
    t.string   "title"
    t.text     "content"
    t.index ["custom_page_id"], name: "index_custom_page_translations_on_custom_page_id", using: :btree
    t.index ["locale"], name: "index_custom_page_translations_on_locale", using: :btree
  end
  ...
  create_table "customer_discounts", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["customer_id"], name: "index_customer_discounts_on_customer_id", using: :btree
    t.index ["discount_id"], name: "index_customer_discounts_on_discount_id", using: :btree
    t.index ["order_id"], name: "index_customer_discounts_on_order_id", using: :btree
  end
  ...
  create_table "menu_item_translations", force: :cascade do |t|
    ...
    t.datetime "updated_at",   null: false
    t.string   "name"
    t.index ["locale"], name: "index_menu_item_translations_on_locale", using: :btree
    t.index ["menu_item_id"], name: "index_menu_item_translations_on_menu_item_id", using: :btree
  end
  ...
  create_table "order_products", force: :cascade do |t|
    ...
    t.index ["variation_id"], name: "index_order_products_on_variation_id", using: :btree
  end
  ...
  create_table "payment_method_option_shops", force: :cascade do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["payment_method_option_id"], name: "index_payment_method_option_shops_on_payment_method_option_id", using: :btree
    t.index ["payment_method_shop_id"], name: "index_payment_method_option_shops_on_payment_method_shop_id", using: :btree
  end
  ...
  create_table "payment_method_options", force: :cascade do |t|
    ...
    t.datetime "created_at",                     null: false
    t.datetime "updated_at",                     null: false
    t.index ["payment_method_id"], name: "index_payment_method_options_on_payment_method_id", using: :btree
  end
  ...
  create_table "payment_method_shops", force: :cascade do |t|
    ...
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
    t.index ["payment_method_id"], name: "index_payment_method_shops_on_payment_method_id", using: :btree
    t.index ["shop_id"], name: "index_payment_method_shops_on_shop_id", using: :btree
  end
  ...
  create_table "seo_tag_translations", force: :cascade do |t|
    ...
    t.index ["locale"], name: "index_seo_tag_translations_on_locale", using: :btree
    t.index ["seo_tag_id"], name: "index_seo_tag_translations_on_seo_tag_id", using: :btree
  end
  ...
  create_table "shipping_method_translations", force: :cascade do |t|
    ...
    t.string   "name"
    t.text     "description"
    t.index ["locale"], name: "index_shipping_method_translations_on_locale", using: :btree
    t.index ["shipping_method_id"], name: "index_d18925c68417b15023b73190fb04cfcefbb8f8d5", using: :btree
  end
  ...
  create_table "shipping_rate_translations", force: :cascade do |t|
    ...
    t.datetime "updated_at",       null: false
    t.string   "name"
    t.index ["locale"], name: "index_shipping_rate_translations_on_locale", using: :btree
    t.index ["shipping_rate_id"], name: "index_shipping_rate_translations_on_shipping_rate_id", using: :btree
  end
  ...
  create_table "shops", force: :cascade do |t|
    ...
    t.index ["privacy_id"], name: "index_shops_on_privacy_id", using: :btree
    t.index ["term_id"], name: "index_shops_on_term_id", using: :btree
    t.index ["theme_id"], name: "index_shops_on_theme_id", using: :btree
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.index ["theme_id"], name: "index_templates_on_theme_id", using: :btree
  end
  ...
  create_table "theme_bundles", force: :cascade do |t|
    ...
    t.text     "locale"
    t.text     "template"
    t.index ["shop_id"], name: "index_theme_bundles_on_shop_id", using: :btree
    t.index ["theme_id"], name: "index_theme_bundles_on_theme_id", using: :btree
  end
  ...
  create_table "variation_option_values", force: :cascade do |t|
    ...
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["variation_option_id"], name: "index_variation_option_values_on_variation_option_id", using: :btree
  end
  ...
  create_table "variation_options", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_variation_options_on_product_id", using: :btree
  end
  ...
  create_table "variation_variation_option_values", force: :cascade do |t|
    ...
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.index ["variation_id"], name: "index_variation_variation_option_values_on_variation_id", using: :btree
    t.index ["variation_option_value_id"], name: "option_value_id", using: :btree
  end
